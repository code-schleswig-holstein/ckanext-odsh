...
class StatistikamtNordHarvester(ODSHBaseHarvester):
	...
	extras.append({'key': 'licenseAttributionByText', 'value': 'Statistisches Amt für Hamburg und Schleswig-Holstein - Anstalt des öffentlichen Rechts - (Statistikamt Nord)'})
